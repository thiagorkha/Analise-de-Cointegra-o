    ...
    if st.sidebar.button('Buscar'):
      ...
      for par in pares1:
        for periodo in periodos:
          ...
          h, _ = hurst_calc((coint['OLS']).resid)
          ...
          lst = []
          df = pd.DataFrame(lst, columns = ['Dependente', 'Independente', 'ADF', 'Meia vida','Hurst', 'Periodo', 'Periodo analisado', 'Residuo', 'Desvio', 'Coef. Ang.'] )  
